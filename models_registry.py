...
def load_models():
    ...
    models["text_generation2"] = pipeline("text-generation", model="EleutherAI/gpt-neo-125M")
    models["text_generation3"] = pipeline("text-generation", model="microsoft/DialoGPT-medium")
