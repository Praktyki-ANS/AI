  ...
  export const Models = [
    {
      ...
      imageUrl: chat1,
      title: "Bart ",
      description : "facebook/bart-large-cnn to model oparty na architekturze BART, zaprojektowany do sumaryzacji tekstu. Łączy cechy BERT i GPT, umożliwiając efektywne przetwarzanie tekstu oraz generowanie spójnych streszczeń o różnej długości.",
    },
    {
      id: "1",
      type: "chat",
