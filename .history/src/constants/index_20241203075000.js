  ...
  export const Models = [
    {
      ...
      imageUrl: chat1,
      title: "Bart ",
      description : "Model facebook/bart-large-cnn to zaawansowany model oparty na architekturze BART, zaprojektowany do zadań przetwarzania języka naturalnego, w szczególności sumaryzacji tekstu. Łączy cechy modeli BERT i GPT, co umożliwia efektywne przetwarzanie tekstu w kontekście i sekwencyjnie. Wytrenowany na dużych zbiorach danych, generuje streszczenia o różnej długości, zachowując sens i strukturalną spójność, co czyni go jednym z najskuteczniejszych modeli do sumaryzacji",
    },
    {
      id: "1",
      type: "chat",
