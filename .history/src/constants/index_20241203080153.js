 ...
 export const navLinks = [
  ...
  export const Models = [
    ...
    },
    {
      ...
      imageUrl: chat5,
      title: "GPT-2 ",
      description : "Model openai-community/gpt2 to wersja GPT-2, stworzona do generowania naturalnego tekstu. Oparty na architekturze transformera, został wytrenowany na dużym zbiorze danych, co umożliwia mu tworzenie spójnych i kontekstowych tekstów. Wersja społecznościowa zachowuje kluczowe zdolności GPT-2, takie jak pisanie i tłumaczenie, ale jest zoptymalizowana do mniej zasobochłonnych aplikacji.",
    },
    {
      id: "5",
      type: "imgGen",
