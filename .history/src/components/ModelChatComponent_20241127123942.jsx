...
import { sendMessage } from './chatSlice';  // Zakładam, że ścieżka do chatSlice.js jest odpowiednia
...
const ModelChatComponent = ({ ModelId }) => {
  ...
  const { messages, isSending: reduxIsSending, error } = useSelector(state => state.chat);
    ...
    <div className='chat-container bg-light-glass'>
      ...
      <div className='input-box '>
        ...
        <button 
          ...
          disabled={reduxIsSending || !input.trim()} 
          className={`send-button ${reduxIsSending || !input.trim() ? 'disabled' : ''}`}
        >
