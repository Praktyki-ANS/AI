...
const ModelChatComponent = ({ modelId }) => {  // Używamy dynamicznego modelId przekazanego z linku
    ...
    const handleSendMessage = async () => {
        if (input.trim()) {
            const endpoint = modelEndpoints[modelId]; // Pobieranie odpowiedniego endpointu na podstawie modelId
            if (!endpoint) {
            ...
            try {
                ...
                if (response.data.error) {
                    ...
                    const output = response.data.summarization || 
