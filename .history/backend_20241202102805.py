...
# Włączenie opcji OneDNN dla TensorFlow, jeśli używasz tego frameworka
os.environ["TF_ENABLE_ONEDNN_OPTS"] = "0"

# Słownik przechowujący załadowane modele
models = {}

# Kontekst zarządzania modelem (ładowanie/zwalnianie)
@asynccontextmanager
...
# Tworzenie aplikacji FastAPI z obsługą CORS
app = FastAPI(lifespan=lifespan)

# Dodanie CORS, aby umożliwić zapytania z różnych źródeł
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # Pozwól na zapytania ze wszystkich źródeł
    allow_credentials=True,
    allow_methods=["*"],  # Pozwól na wszystkie metody (GET, POST, OPTIONS, etc.)
